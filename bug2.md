...
20. **11. REJECT 오퍼가 과도하게 `LOWBALL`로 승격되어 억제 장치가 무력화됨**
21. **18. 탐욕적 fill이 고가치 선수를 먼저 집어 넣어 저·중티어 딜에서 과지출을 유발함**
22. **26. `repair_until_valid_many` 도입 후 repaired variant 루프에서 예산/하드캡 체크가 빠짐**
23. **31. bubble bonus가 실제 cutoff 경쟁 중이 아닌 팀에도 잘못 적용됨**
24. **7. 숫자 정렬 CSS가 Trade Block 테이블까지 오염시킴**
25. **17. 아웃고잉 후보 빌더가 실제로는 내보낼 수 없는 선수까지 포함함**
26. **23. template-first 비활성 시 combined routing이 아예 비어버릴 수 있음**
27. **25. 보호 변형 평가에서 `opponent_repeat_count=0`이 하드코딩되어 파트너 반복 패널티가 무시됨**
