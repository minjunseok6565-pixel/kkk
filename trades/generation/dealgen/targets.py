...
def select_targets_buy(
    ...
    *,
    ...
    for r in refs:
        ...
        # Explicit PUBLIC trade-block listings must remain discoverable even when the
        # seller team is in cooldown, otherwise user-listed players can become
        # completely invisible to AI buy retrieval.
