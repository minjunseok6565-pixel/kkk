...
OFFENSE_SCHEME_MULT: Dict[str, Dict[str, Dict[str, float]]] = {
    ...
    "Preset_Offense": {"PnR": {"PASS_SHORTROLL":1.01, "PASS_KICKOUT":1.01, "SHOT_3_OD":1.01, "SHOT_MID_PU":0.99, "RESET_RESREEN":1.00},
                       "PnP": {"SHOT_3_CS":1.02, "PASS_KICKOUT":1.01, "SHOT_MID_CS":1.00, "SHOT_RIM_LAYUP":0.99},
                       "Drive": {"SHOT_RIM_LAYUP":1.01, "PASS_KICKOUT":1.01, "SHOT_MID_PU":0.99},
                       "ISO": {"SHOT_RIM_LAYUP":1.01, "SHOT_3_OD":1.00, "SHOT_MID_PU":0.99, "PASS_KICKOUT":1.00},
                       "Kickout": {"SHOT_3_CS":1.01, "PASS_EXTRA":1.01, "PASS_SKIP":1.00},
                       "ExtraPass": {"SHOT_3_CS":1.01, "PASS_SKIP":1.01},
                       "Cut": {"SHOT_RIM_LAYUP":1.01, "PASS_KICKOUT":1.00},
                       "DHO": {"SHOT_3_OD":1.01, "SHOT_3_CS":1.00, "PASS_KICKOUT":1.00, "RESET_REDO_DHO":1.00},
                       "PostUp": {"SHOT_POST":1.01, "PASS_KICKOUT":1.00, "FOUL_DRAW_POST":1.00, "RESET_POST_OUT":1.00},
                       "TransitionEarly": {"SHOT_RIM_DUNK":1.01, "SHOT_RIM_LAYUP":1.00, "SHOT_3_CS":1.00, "PASS_KICKOUT":1.00, "FOUL_DRAW_RIM":1.00, "TO_HANDLE_LOSS":1.00}},
}
